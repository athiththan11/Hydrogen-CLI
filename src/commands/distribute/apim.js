		...
		try {
			...
			if (
				...
				if (flags[ConfigMaps.Hydrogen.layout.apim.distributed]) {
					...
					let kmlayoutConfs = Samples.Models.kmlayoutConfs;
					let gatewaylayoutConfs = Samples.Models.gatewaylayoutConfs;
					...
					if (flags.config && config != null) {
						...
						tmlayoutConfs = config.tmlayoutConfs;
						storelayoutConfs = config.storelayoutConfs;
						publisherlayoutConfs = config.publisherlayoutConfs;
						kmlayoutConfs = config.kmlayoutConfs;
						gatewaylayoutConfs = config.gatewaylayoutConfs;
					}
